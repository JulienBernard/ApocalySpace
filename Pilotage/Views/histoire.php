		<div class="row">
			...
			<article class="large-9 columns">
				...
				<h1>Jouabilité</h1>
				<p class="small">
					Profitant d'une communauté soudée, vous pourrez intéragir avec n'importe quel joueur présent sur le serveur : communications, commerces et attaques ; constructions, recherches et gestion seront votre quotidien !<br />
					<br />
